...
public class JobDetailsScreen extends AppCompatActivity {
    ...
    private void populateWorkers(ListView workerView, SharedPreferences sharedPreferences, APIDataService service, String jobid)
    {
        ...
        service.callAPIURL("/jobWorkers/readWorker", params, Request.Method.GET, response -> {
            try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sp.getString("email", "").equals(email)) {
            ...
            service.callAPIURL("/job/checkStatus", params, Request.Method.GET, response -> {
                try {
        ...
        acceptJobButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    service.callAPIJSON("/job/acceptJob", params, Request.Method.POST, response -> {
                        try {
                ...
                {
                    service.callAPIURL("/jobWorkers/deleteWorker", params, Request.Method.DELETE, response -> {
                        try {
                            String success = response.getString("success");
                            if (success.equals("true")) {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which){
                            case DialogInterface.BUTTON_POSITIVE:
                                //Yes button clicked
                                service.callAPIURL("/job/deleteJob", params, Request.Method.DELETE, response->{
                                    try {
                                        String success = response.getString("success");
                                        if (success.equals("true"))
                                        {
        ...
        submitJobButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                service.callAPIJSON("/job/changeStatus", changeParams, Request.Method.PUT, response->{
                    try {
                        String success = response.getString("success");
                        if (success.equals("true"))
                        {
